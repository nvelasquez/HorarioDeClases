...
public class Interfaz {
	...
	public static String finProceso(String proceso, boolean todoBien){
        ...
        public static void consultarHorario(){
            ...
            while(it.hasNext()){
                Horario hor = it.next();
                System.out.println("Profesor: "+hor.getNombreProfesor()
                                  +" Materia: "+hor.getNombreMateria()
                                  +" Tanda: "+hor.getTanda()
                                  +" Horas de Clase: "+hor.getHorasDocencia()
                                  +" Dia: "+hor.getDia()
                                  );
                imprimir();
            }
        ...
        public static void imprimir(){
            ...
            if(proceso.equalsIgnoreCase("si")){
                ...
                crearEncabezado(Institucion.getNombreInstitucion());
            }
        }
